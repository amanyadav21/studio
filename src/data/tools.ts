...
export const tools: Tool[] = [
  ...
  // Major Cloud Providers
  {
    ...
    description: 'GCP\'s free tier includes App Engine, Firestore, Compute Engine (e2-micro), Cloud Storage (5GB), Pub/Sub, Functions, and more. Ideal for prototyping and small applications.',
  ...
  },
  {
    ...
    description: 'AWS offers a generous free tier including EC2 (t2.micro/t3.micro), S3 (5GB), RDS, Lambda (1M requests/mo), DynamoDB (25GB), and more for 12 months.',
  ...
  },
  {
    ...
    description: 'Azure\'s free account includes Virtual Machines (B1S), App Service, Functions (1M requests/mo), Cosmos DB (25GB), and a suite of AI/ML services.',
  ...
  },
  {
    ...
    name: 'Oracle Cloud',
    description: 'Oracle\'s Always Free tier provides AMD and Arm-based Compute VMs, 200GB Block Volume, 10GB Object Storage, and two databases.',
  ...
  },
  {
    ...
    name: 'IBM Cloud',
    description: 'IBM\'s Lite plan includes free access to Cloudant and Db2 databases, API Connect (50k calls/mo), and Log Analysis.',
  ...
  },
  {
    ...
    name: 'Cloudflare',
    description: 'Cloudflare\'s free plan offers unmetered DDoS protection, CDN, free SSL, Workers (100k daily requests), R2 Storage (10GB/mo), and Pages hosting.',
