...
export const tools: Tool[] = [
  ...
  },
  {
    id: "localforage",
    name: "localForage",
    description: "Improves offline experience with simple, asynchronous client-side data storage.",
  ...
  },
  {
    id: "dexie-js",
    name: "Dexie.js",
    description: "A minimalistic wrapper for IndexedDB - the standard database in the browser.",
    url: "https://dexie.org/",
    category: "Frameworks & Libraries",
    subcategory: "Frontend",
  },
  {
    id: "pouchdb",
    name: "PouchDB",
    description: "A pocket-sized, in-browser database that allows applications to store data locally.",
  ...
  },
  {
    id: "zustand",
    name: "Zustand",
    description: "A small, fast and scalable state-management solution with a middleware for localStorage.",
