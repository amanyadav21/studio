...
import type { Tool, ToolCategory, FrameworkSubCategory, UiUxSubCategory, ProductivitySubCategory, NoCodeSubCategory, ApiSubCategory, AiMlSubCategory, EducationalPlanSubCategory } from "@/lib/types";
...
export const tools: Tool[] = [
  ...
  // Major Cloud Providers
  {
    ...
    details: [
      ...
      'Cloud Firestore: 1GB storage, 50k reads, 20k writes, 20k deletes/day',
      'Compute Engine: 1 non-preemptible e2-micro, 30GB HDD, 5GB snapshot storage',
      'Cloud Storage: 5GB, 1GB network egress/month',
      'Cloud Shell: Web-based Linux shell with 5GB storage (60 hours/week)',
      'Cloud Pub/Sub: 10GB of messages/month',
      'Cloud Functions: 2 million invocations/month',
      'Cloud Run: 2 million requests/month, 360k GB-seconds memory',
      'Google Kubernetes Engine: No cluster management fee for one zonal cluster',
      'BigQuery: 1 TB of querying/month, 10 GB of storage/month',
      'Cloud Build: 120 build-minutes/day',
      'Cloud Source Repositories: Up to 5 Users, 50GB Storage & Egress',
      'Google Colab: Free Jupyter Notebooks environment',
    ],
  ...
  },
  {
    ...
    details: [
      'CloudFront: 1TB egress/month, 2M function invocations/month',
      'EC2: 750 hours/month of t2.micro or t3.micro (12mo)',
      'S3: 5GB Standard object storage, 20k Get & 2k Put requests (12mo)',
      'RDS: 750 hours/month of db.t2.micro/db.t3.micro, 20GB SSD storage (12mo)',
      'Lambda: 1 million requests/month (Always Free)',
      'DynamoDB: 25GB NoSQL DB (Always Free)',
      'CodeBuild: 100 build minutes/month',
      'SNS: 1 million publishes/month (Always Free)',
      'SQS: 1 million messaging queue requests (Always Free)',
    ],
  ...
  },
  {
    ...
    details: [
      ...
      'Functions: 1 million requests/month (Always Free)',
      'Azure DevOps: 5 active users, unlimited private Git repos',
      'Static Web Apps: Host static apps and serverless functions with free SSL',
      'Cosmos DB: 25GB storage and 1000 RUs throughput (Always Free)',
      'Storage: 5GB LRS File or Blob storage (12mo)',
      'Bandwidth: 100GB egress/month (was 5GB)',
      'Cognitive Services: AI/ML APIs with a free tier',
    ],
  ...
  },
  {
    ...
    details: [
      'Compute: 2 AMD-based VMs, 4 Arm-based Ampere A1 cores & 24 GB RAM',
      'Block Volume: 2 volumes, 200 GB total',
      'Object Storage: 10 GB',
      'Databases: 2 DBs, 20 GB each',
      'Bandwidth: 10 TB egress/month',
      'Load Balancer: 1 instance with 10 Mbps',
      'Public IP: 2 IPv4 for VMs, 1 for load balancer',
    ],
  ...
  },
  {
    ...
    details: [
      ...
      'Availability Monitoring: 3 million data points/month',
      'Log Analysis: 500MB of daily log data',
    ],
  ...
  },
  {
    ...
    details: [
      'Application Services: Free DNS, DDoS Protection, CDN, SSL',
      'Workers: 100k daily serverless requests',
      'R2 Storage: 10 GB/month',
      'D1 Database: 5M rows read/day, 100k rows written/day, 1 GB storage',
      'Pages: 500 monthly builds, 100 custom domains, unlimited sites',
      'Queues: 1 million operations/month',
      'Cloudflare Tunnel: Securely expose local servers to the internet',
    ],
